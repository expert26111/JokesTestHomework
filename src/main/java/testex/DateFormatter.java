 ...
 */
    ...
    //put a Date object as argument make it deterministic
...
//    }
//    Date time = new Date();//problematic non-deterministic behavior
...
//  
   ...
   @Override
   public  String getFormattedDate(Date dateObject, String timeZone) 
  {
//    if(!Arrays.asList(TimeZone.getAvailableIDs()).contains(timeZone))
//    {
//      throw new JokeException("Illegal Time Zone String");
//    }
    ...
    SimpleDateFormat simpleFormat = new SimpleDateFormat(dateTimeFormat);
    simpleFormat.setTimeZone(TimeZone.getTimeZone(timeZone));
    return simpleFormat.format(dateObject); 
  // return simpleFormat.
  }
...
//    }
    ...
    //System.out.println(new DateFormatter().getFormattedDate("Europe/Sofia"));
